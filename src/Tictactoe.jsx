...
import circle_icon from './Assets/circles.png'
...
function Tictactoe() {
  ...
  return (
      <div className='container'>
          <h1 className='title' ref={titleRef}> &nbsp;&nbsp;&nbsp; Tic Tac Toe Game </h1><br />
          <div className="board">
              <div className="row1">
          ...
          <MDBBtn outline color='dark' onClick={()=>{reset()}}> <b>Reset</b> </MDBBtn>
      </div>
